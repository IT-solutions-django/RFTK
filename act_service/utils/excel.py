    ...
    try:
        ...
        if pdf:
            ...
            with open(temp_modified_pdf_path, "rb") as pdf_file:
                ...
                if watch_document:
                    response["Content-Disposition"] = "inline; filename=act_service.pdf"
                else:
                    response["Content-Disposition"] = "attachment; filename=act_service.pdf"
        ...
        response["Content-Disposition"] = f"attachment; filename=act_service.xlsx"

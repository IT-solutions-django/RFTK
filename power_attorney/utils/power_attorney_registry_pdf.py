...
def create_power_attorney_registry_pdf(html, download_pdf=False):
    ...
    with tempfile.NamedTemporaryFile(suffix=".html", delete=False, mode="w", encoding="utf-8") as temp_html:
        ...
        with open(result_pdf_file, "rb") as pdf_file:
            ...
            if download_pdf:
                response["Content-Disposition"] = "attachment; filename=power_attorney_registry.pdf"
            else:
                response["Content-Disposition"] = "inline; filename=power_attorney_registry.pdf"
